...
clc
%%
data = load('ArsalanEpochAVGRefICA.txt');
%%
data = reshape(data,19,34000,9);
% data = Data;

%% Total Powers
fs = 200;
TotalPowers = zeros(19,9);
for ch = 1:19
    for trial = 1:9
...
%%
fs = 200;
DeltaPowers = zeros(19,9);
ThetaPowers = zeros(19,9);
AlphaPowers = zeros(19,9);
BetaPowers = zeros(19,9);
GamaPowers = zeros(19,9);
for ch = 1:19
    for trial = 1:9
